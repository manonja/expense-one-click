  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-3 sm:p-6 bg-gray-50">
      <main className="max-w-3xl w-full bg-white rounded-lg shadow-lg p-4 sm:p-8">
        {/* Keep the powerful headline and subheader */}
        <h1 className="text-3xl sm:text-4xl font-bold text-center mb-4 sm:mb-6 text-gray-800">
          Turn Receipts Into QuickBooks Expenses<br />In Just 5 Seconds
        </h1>
        
        <p className="text-base sm:text-lg text-center mb-6 sm:mb-8 text-gray-600">
          Stop wasting hours manually entering receipts. Take a photo and let our app do the rest - with perfect accuracy for small business owners and freelancers.
        </p>
